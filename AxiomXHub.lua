...
AxiomX["1"] = Instance.new("ScreenGui", game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui"));
AxiomX["1"]["ZIndexBehavior"] = Enum.ZIndexBehavior.Sibling;

AxiomX["2"] = Instance.new("Frame", AxiomX["1"]);
AxiomX["2"]["BorderSizePixel"] = 0;
AxiomX["2"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0);
AxiomX["2"]["Size"] = UDim2.new(0, 50, 0, 50);
AxiomX["2"]["Draggable"] = true
...
AxiomX["4"] = Instance.new("TextButton", AxiomX["2"]);
AxiomX["4"]["TextWrapped"] = true;
AxiomX["4"]["BorderSizePixel"] = 0;
AxiomX["4"]["TextSize"] = 14;
AxiomX["4"]["TextColor3"] = Color3.fromRGB(255, 255, 255);
AxiomX["4"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
AxiomX["4"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
AxiomX["4"]["Size"] = UDim2.new(0, 50, 0, 56);
AxiomX["4"]["BackgroundTransparency"] = 1;
AxiomX["4"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
AxiomX["4"]["Text"] = [[STOP TWEEN]];
AxiomX["4"]["Position"] = UDim2.new(0, 0, -0.07273, 0);
AxiomX["5"] = Instance.new("UIStroke", AxiomX["4"]);
...
AxiomX["4"].MouseButton1Click:Connect(function()
    StopTween()
end)
